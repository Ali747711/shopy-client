...
import { PersonalizedRecommendations } from "@/components/landing/personalized-recommendations";
...
export function LandingExperience() {
  ...
  return (
    <main className="lime-wash relative min-h-svh">
      ...
      {/* Feature 5: Recently viewed — appears on the home page once there's history */}
